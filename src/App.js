...
export default function App() {
  ...
  <>
    ...
    {showLoader ? (
      <div className="loader-container">
        <img src={process.env.PUBLIC_URL + '/cfcode.gif'} alt="CFCode Loader" />
      </div>
    ) : (
      <>
        ...
        <label className="labelInput">Tweet Text</label>
        <input
          className="input"
          type="textarea"
          value={tweet}
        ...
        <label className="labelInput">Views</label>
        <input
          className="input"
          type="text"
          value={view}
        ...
        <label className="labelInput">Retweets</label>
        <input
          className="input"
          type="number"
          value={retweet}
  ...
  <img src={process.env.PUBLIC_URL + '/cfcode.png'} alt="CFCode Logo" />
</div>
